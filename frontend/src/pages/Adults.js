  ...
  return (
    <div>
      <div className="flex-between">
        <h1>Adults & Guardians</h1>
      </div>

      <div className="info-message">
        <p>These are all the adults and guardians registered in your club: <strong>{user?.club?.name}</strong></p>
      </div>
      ...
      <div className="card" style={{ marginBottom: '1rem' }}>
        <div className="card-header">
          <input
            type="text"
            placeholder="Search by adult name, email, or children's names..."
            value={searchTerm}
      ...
      {filteredParents.length === 0 ? (
        <div className="card">
          <div className="card-header">
            <h3 className="card-title">No Adults Found</h3>
          </div>
          <div>
            {parents.length === 0 ? (
              <>
                <p>No adults have been registered in your club yet.</p>
                <p>Adults can join by accepting invitations or registering directly.</p>
              </>
            ) : (
              <p>No adults match your search criteria.</p>
            )}
          </div>
        </div>
      ) : (
        <div className="card">
          <div className="card-header">
            <h3 className="card-title">Club Adults ({filteredParents.length})</h3>
          </div>
