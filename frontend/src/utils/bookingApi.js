...
export const bookingApi = {
  ...
  getAllClubGymnasts: () =>
    axios.get(`${API_URL}/gymnasts`, { headers: getHeaders() }),
  ...
  resetMembership: (id, skipEmail = false) =>
    axios.post(`${API_URL}/booking/memberships/${id}/reset`, { skipEmail }, { headers: getHeaders() }),
  ...
  getAdminPayments: (month) =>
    axios.get(`${API_URL}/booking/admin/payments${month ? `?month=${month}` : ''}`, { headers: getHeaders() }),
  ...
  getAllCompetitionGymnasts: (eventId) =>
    axios.get(`${API_URL}/booking/competition-events/${eventId}/all-gymnasts`, { headers: getHeaders() }),
